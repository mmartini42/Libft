...
SRCS = ./ft_atoi.c ./ft_memset.c ./ft_strlen.c ./ft_strlcat.c ./ft_bzero.c ./ft_memcpy.c ./ft_memccpy.c ./ft_memmove.c \
	...
	./ft_strjoin.c ./ft_strtrim.c ./ft_calloc.c ./ft_strlcpy.c ./ft_split.c ./ft_itoa.c ./ft_putchar_fd.c ./ft_putstr_fd.c \
	./ft_putendl_fd.c ./ft_putnbr_fd.c ./ft_substr.c ./ft_lstnew.c ./ft_lstadd_front.c ./ft_lstsize.c ./ft_lstlast.c \
	./ft_lstadd_back.c
